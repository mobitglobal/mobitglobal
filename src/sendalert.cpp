...
2. run mobitglobald with -printalert or -sendalert like this:
   /path/to/mobitglobald -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Mobit Global Core:0.12.0.58/"));
