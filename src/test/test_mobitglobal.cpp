...
#define BOOST_TEST_MODULE Mobit Global Test Suite

#include "test_mobitglobal.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_mobitglobal_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
