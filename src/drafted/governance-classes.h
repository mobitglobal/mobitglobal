 ...
 *
 *   // network
 *   CMobitGlobalNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CMobitGlobalNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CMobitGlobalNetwork(UniValue objIn)
    {
...
// // can be under: MobitGlobalNetwork
// //   -- signature requirements : Key1(User)
// class CMobitGlobalNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == MobitGlobalNetwork);
//     // }
