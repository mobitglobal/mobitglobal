...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "MobitGlobalNetwork") type = MobitGlobalNetwork;
    if(strType == "MobitGlobalNetworkVariable") type = MobitGlobalNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == MobitGlobalNetwork) s = "MobitGlobalNetwork";
    if(type == MobitGlobalNetworkVariable) s = "MobitGlobalNetworkVariable";
