...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Mobit Global Core mobitglobal-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mobitglobal-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mobitglobal transaction") + "\n" +
              "  mobitglobal-tx [options] -create [commands]   " + _("Create hex-encoded mobitglobal transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mobitglobal transaction
