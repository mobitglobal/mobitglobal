...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(BitcoinUnits::MBGL),
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("MBGL")
        updateDisplayUnit();
...
void OverviewPage::updateAdvancedPSUI(bool fShowAdvancedPSUI) {
    ...
    ui->framePrivateSend->setVisible(privateSendClient.fEnablePrivateSend);
