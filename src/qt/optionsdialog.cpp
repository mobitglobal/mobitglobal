    ...
    mapper(0)
{
    ...
    /* Theme selector */
    //ui->theme->addItem(QString("MBGL-light"), QVariant("light"));
    ////ui->theme->addItem(QString("MBGL-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("MBGL-blue"), QVariant("drkblue"));
    ////ui->theme->addItem(QString("MBGL-Crownium"), QVariant("crownium"));
    //ui->theme->addItem(QString("MBGL-traditional"), QVariant("trad"));
