    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Mobit Global Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Mobit Global Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  mobitglobal-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Mobit Global in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MBGL, 0.1 MBGL, 1 MBGL and 10 MBGL -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Mobit Global Core is shutting down...") + "<br /><br />" +
