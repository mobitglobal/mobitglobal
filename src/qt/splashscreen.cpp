    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int titleCopyrightVSpace    = 31;

    float fontFactor            = 1.0;

    // define text to place
    QString titleText       = tr("Mobit Global Core");
    ...
    QString copyrightTextMobitGlobal   = QChar(0xA9)+QString(" 2018-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Mobit Global Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+24,copyrightTextMobitGlobal);
