    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Mobit Global Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a mobitglobal address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mbgl: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Mobit Global Core"), this);
    aboutAction->setStatusTip(tr("Show information about Mobit Global Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Mobit Global Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your mobitglobal addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified mobitglobal addresses"));
    ...
    openAction->setStatusTip(tr("Open a mbgl: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Mobit Global Core help message to get a list with possible Mobit Global Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Mobit Global Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Mobit Global network", "", count));
    } else {
...
{
    QString strTitle = tr("Mobit Global Core"); // default title
    ...
    // Append title to "Mobit Global Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
